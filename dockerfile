...
RUN git clone https://github.com/esimkowitz/mirror-detector.git /notebooks/mirror-detector
RUN git clone https://github.com/tensorflow/models.git /notebooks/mirror-detector/models
